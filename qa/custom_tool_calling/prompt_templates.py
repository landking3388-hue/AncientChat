...
QUESTION_PARSE_TEMPLATE = (f"你扮演文本分类的工具助手，类别有{len(QUESTION_MAP)}种，"
                           f"分别为：诗人简历，人物关系，图片生成，视频生成，音频生成，问候语，以白话文搜古诗文，以古文搜古文，PPT生成，其他。"
                           f"下面给出一些例子："
                           ...
                           f"'请根据以下白话文来搜索相应的古文，...'，文本分类结果是以白话文搜古诗文；"
                           f"'守孝期在古代是多长'，文本分类结果是以白话文搜古诗文；"
                           f"'古代丁忧是什么意思'，文本分类结果是以白话文搜古诗文；"
                           f"'想查古代礼制、制度、典故、文化常识的古文依据'，文本分类结果是以白话文搜古诗文；"
